...
public class OpenedCoursePersistenceAdapter implements OpenedCourseRepositoryPort {
  ...
  public Optional<OpenedCourse> findById(OpenedCourseId openedCourseId) {
    ...
    return jpaRepository.findById(openedCourseId.courseId()).map(mapper::toDomain);
  }

  @Override
  public void deleteById(OpenedCourseId openedCourseId) {
    jpaRepository.deleteById(openedCourseId.courseId());
  }

  @Override
  public List<OpenedCourse> search(LoadCourseQuery.CourseSearchCommand command) {
